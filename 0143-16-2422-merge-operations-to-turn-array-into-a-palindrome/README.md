<h2> 143 16
2422. Merge Operations to Turn Array Into a Palindrome</h2><hr><div><p>You are given an array <code>nums</code> consisting of <strong>positive</strong> integers.</p>
...
<pre><strong>Input:</strong> nums = [4,3,2,1,2,3,1]
