<h2> 1999 41
2134. Minimum Swaps to Group All 1's Together II</h2><hr><div><p>A <strong>swap</strong> is defined as taking two <strong>distinct</strong> positions in an array and swapping the values in them.</p>
